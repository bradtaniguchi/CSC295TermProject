...
public class SearchWindow extends javax.swing.JFrame {
    ...
    public SearchWindow(List<Order> orders) {
        this.orders = orders;
        this.orderNumber = 0; //change to add this into the order itself
        initComponents();
    }
    ...
    private void jButton_serach1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_serach1ActionPerformed
        String query = jTextField_searchName.getText();
    ...
    private void jButton_modifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_modifyActionPerformed
        ...
        dispose();
        /*todo change null to the items given to the search window*/
